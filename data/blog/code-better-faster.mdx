...
![junior versus pro comparison of time spent](/static/images/google.png)
...
- Providing more info not only shows that your code works but also builds up confidence in your
  code in the eyes of the rest of your team
...
- Don't make the same mistake twice, absorb the feedback, if you don't understand the feedback,
  then ask questions
